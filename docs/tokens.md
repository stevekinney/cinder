...
Root-declared tokens are emitted in [`tokens-base.css`](../packages/components/src/styles/tokens-base.css). A small set of component-owned aliases is intentionally consume-only: it is deferred to the component's consumption site so scoped ancestor overrides continue to flow through the referenced token instead of being masked by a root declaration. The aggregator [`tokens.css`](../packages/components/src/styles/tokens.css) imports the base file and is the entry point components consume.
...
Chat scopes its own measure to its root rather than reading the page-level tokens above. `--cinder-chat-message-max-width` defaults to `48rem` and caps every transcript row — message bubbles and grouped tool-call cards alike — so the two can never drift to different widths. Override it on an individual Chat container, on a wrapping element, or on `:root` to widen or tighten the transcript independently of surrounding page content: the token is registered with `@property` (`syntax: '*'`, `inherits: true`, `initial-value: 48rem`; a typed syntax cannot carry a `rem` initial value) rather than declared on the Chat root, so an ancestor's value inherits into Chat instead of being reset by the component's own declaration. Every rule that consumes it carries the same `48rem` fallback, so the measure holds even for a consumer that does not import `@lostgradient/chat/styles`.
...
| `--cinder-polarity-ink`            | `light-dark(oklch(0% 0 0), oklch(100% 0 0))`                                                                                                                              | The neutral ink that contrasts with the current theme's surfaces: black in light mode, white in dark mode. It is a complete color value, not a bare component triplet, so it can be assigned directly to any color-valued property and mixed with `color-mix()` to build a wash at any alpha. Every polarity-aware wash in the corpus derives from this one token, so overriding it at :root or in a [data-theme] block re-polarizes all of them together; a subtree override does not reach them, because the washes are declared at :root and descendants inherit the already-resolved values. |
...
| `--cinder-terminal-ansi-black`          | `light-dark(oklch(25% 0 0), oklch(82% 0 0))`             |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-red`            | `light-dark(oklch(42% 0.16 25), oklch(72% 0.14 25))`     |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-green`          | `light-dark(oklch(38% 0.13 145), oklch(72% 0.13 145))`   |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-yellow`         | `light-dark(oklch(48% 0.14 85), oklch(82% 0.13 85))`     |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-blue`           | `light-dark(oklch(40% 0.16 260), oklch(72% 0.15 260))`   |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-magenta`        | `light-dark(oklch(42% 0.16 325), oklch(75% 0.14 325))`   |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-cyan`           | `light-dark(oklch(35% 0.11 205), oklch(75% 0.12 205))`   |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-white`          | `light-dark(oklch(18% 0 0), oklch(94% 0 0))`             |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-bright-black`   | `light-dark(oklch(42% 0 0), oklch(68% 0 0))`             |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-bright-red`     | `light-dark(oklch(52% 0.18 25), oklch(78% 0.15 25))`     |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-bright-green`   | `light-dark(oklch(48% 0.15 145), oklch(80% 0.14 145))`   |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-bright-yellow`  | `light-dark(oklch(52% 0.16 85), oklch(88% 0.14 85))`     |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-bright-blue`    | `light-dark(oklch(50% 0.18 260), oklch(80% 0.16 260))`   |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-bright-magenta` | `light-dark(oklch(54% 0.18 325), oklch(82% 0.15 325))`   |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-bright-cyan`    | `light-dark(oklch(45% 0.13 205), oklch(82% 0.13 205))`   |                                                                                                                                                                                                                                                                                                                              |
| `--cinder-terminal-ansi-bright-white`   | `light-dark(oklch(10% 0 0), oklch(98% 0 0))`             |                                                                                                                                                                                                                                                                                                                              |
...
| `--cinder-border-muted`                   | `color-mix(in oklch, var(--cinder-border-ink), transparent 81%)` | Decorative divider that wants less weight than `border.control`. Clears a separate 1.4:1 floor against its backdrop. Composed as a 19% alpha step over `border.ink`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `--cinder-border-strong`                  | `color-mix(in oklch, var(--cinder-border-ink), transparent 42%)` | Stronger control boundary. Clears WCAG 1.4.11's 3:1 floor against every supported surface, like `border.control`, with more weight. Composed as a 58% alpha step over `border.ink`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
The three structural tiers — `--cinder-border-muted`, `--cinder-border`, and `--cinder-border-strong` — are not authored separately. Each is one alpha step over `--cinder-border-ink`: 19%, 48%, and 58% respectively, with the ink carrying the light/dark polarity so the same three percentages serve both arms. Retinting all three at once therefore means overriding one token:
...
| `--cinder-severity-critical`            | `light-dark(oklch(38% 0.18 25), oklch(95% 0.04 25))`    | Highest-severity badge foreground.                                                                                                                     |
| `--cinder-severity-critical-background` | `light-dark(oklch(93% 0.045 25), oklch(24% 0.11 25))`   | Highest-severity badge background.                                                                                                                     |
