...
| `number-input/number-input.svelte`                                                   | Increment/decrement steppers | Additional interactive `+`/`−` affordance found; file a follow-up to apply this convention.                          |
| `menu-bar/menu-bar.svelte`                                                           | Submenu indicator            | Additional interactive `>` affordance found; file a follow-up to use `ChevronRight`.                                 |
