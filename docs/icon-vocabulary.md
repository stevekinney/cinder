...
| `pagination/pagination.svelte`, `media-controls/media-controls.svelte`, `selection-popover/selection-popover.svelte`                                                | Hand-authored action icons   | Interactive SVG action icons remain; migrate them to the named Lucide vocabulary in [#1017](https://github.com/stevekinney/cinder/issues/1017).                                                                                               |
