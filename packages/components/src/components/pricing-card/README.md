...
| `onselect` | `(opaque)` | yes      | —       | Called when the CTA button is clicked. A function or snippet prop. Its shape is not captured by the JSON schema; see the component types for the exact signature. |
