...
| --------------- | ------------------------------------- | -------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `checked`       | `boolean`                             | no       | —       | Checked state for `itemRole="menuitemradio"`. Omitted for normal menu items.                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `itemRole`      | `"menuitem"` \| `"menuitemradio"`     | no       | —       | ARIA role for the row. Use `menuitemradio` for mutually exclusive menu selections.                                                                                                                                                                                                                                                                                                                                                                                                                        |
