...
| --------------- | --------------------------------------------------------- | -------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `checked`       | `boolean`                                                 | no       | —       | Checked state for checkbox and radio menu items. Omitted for normal menu items.                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `itemRole`      | `"menuitem"` \| `"menuitemcheckbox"` \| `"menuitemradio"` | no       | —       | ARIA role for the row. Use `menuitemcheckbox` or `menuitemradio` for selectable menu items.                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `variant`       | `"default"` \| `"danger"`                                 | no       | —       | Visual style of the item. Use `status.danger.solid` to signal a destructive action. Default `default`.                                                                                                                                                                                                                                                                                                                                                                                                    |
