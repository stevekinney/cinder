...
| `children`    | `(opaque)`              | yes      | —       | Radio children. A function or snippet prop. Its shape is not captured by the JSON schema; see the component types for the exact signature. |
