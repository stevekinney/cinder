...
| `children`         | `(opaque)`                                          | no       | —           | Item body content. A function or snippet prop. Its shape is not captured by the JSON schema; see the component types for the exact signature.                                                        |
| `marker`           | `(opaque)`                                          | no       | —           | Decorative custom marker glyph. Must not contain interactive descendants. A function or snippet prop. Its shape is not captured by the JSON schema; see the component types for the exact signature. |
