# Statistic — Accessibility Notes

## ARIA Roles and Attributes

### Root element (`.cinder-statistic`)
...
### Change indicator (`.cinder-statistic__change`)
...
### Icon snippet (`.cinder-statistic__icon`)
