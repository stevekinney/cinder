...
| `arrowVisible`           | `boolean`                                                                                                            | no       | —       | Render a directional arrow on the panel. Default `false`.                                                                                                                                                                         |
| `class`                  | `string`                                                                                                             | no       | —       | Extra class merged onto `.cinder-popover`.                                                                                                                                                                                        |
| `closeOnEscape`          | `boolean`                                                                                                            | no       | —       | Whether Escape closes the Popover. Default `true`. Set `false` when a parent composite widget (e.g. Combobox) owns Escape for the whole interaction, so the Popover does not shadow the parent's handler while its panel is open. |
...
| `portalScopeClass`       | `string`                                                                                                             | no       | —       | Extra class merged onto the portaled scope wrapper.                                                                                                                                                                               |
...
| `initialFocus`           | `(opaque)`                                                                                                           | no       | —       | Optional callback for choosing the element that receives initial panel focus. Not expressible in JSON Schema; see the component types for the signature.                                                                          |
| `outsideClickIgnoreRefs` | `(opaque)`                                                                                                           | no       | —       | Additional elements treated as inside for outside dismissal. Not expressible in JSON Schema; see the component types for the signature.                                                                                           |
