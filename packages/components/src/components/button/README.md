...
| `leadingIcon`  | `(opaque)`                                                                                                 | no       | —             | DECORATIVE icon rendered before the label/children. Always wrapped in aria-hidden. If the icon conveys meaning, supply accessible text via `label`/`aria-label` instead. A function or snippet prop. Its shape is not captured by the JSON schema; see the component types for the exact signature. |
| `trailingIcon` | `(opaque)`                                                                                                 | no       | —             | DECORATIVE icon rendered after the label/children. Always wrapped in aria-hidden. Same accessible-name guidance as `leadingIcon`. A function or snippet prop. Its shape is not captured by the JSON schema; see the component types for the exact signature.                                        |
