...
| `timezones`        | `string`[]                                 | no       | —       |                                                                                                                                    |
| `value`            | `string`                                   | no       | —       |                                                                                                                                    |
| `onValueChange`    | `(opaque)`                                 | no       | —       | Called when the user commits a time or timezone change. Not expressible in JSON Schema; see the component types for the signature. |
