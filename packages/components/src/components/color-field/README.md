...
| `formats`         | (`"hex"` \| `"rgb"` \| `"rgba"` \| `"hsl"` \| `"hsla"` \| `"hwb"`)[] | no       | —       | Accepted _input_ formats. Defaults to `['hex', 'rgb', 'hsl', 'hwb']`; rgba/hsla aliases can be restricted independently. Output is always hex.                                                                                                                                                                                              |
