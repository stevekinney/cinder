...
| `formats`        | `readonly ("hex" \| "rgb" \| "hsl")[]`    | no       | —       | Accepted _input_ formats. Defaults to `['hex', 'rgb', 'hsl']`. Passing an empty array uses the same default set. Output is always hex.                                                                                                                                                                                                      |
