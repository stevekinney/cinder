...
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------- | ---------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `arrowVisible` | `boolean`                                                                                                                                                                                  | no       | —                | When true, renders a directional arrow pointing from the card toward the trigger. Default `false`.                         |
| `class`        | `string`                                                                                                                                                                                   | no       | —                | Additional class names merged with the component's root class.                                                             |
| `closeDelay`   | `number`                                                                                                                                                                                   | no       | `150`            | Delay in milliseconds before the card closes after the pointer leaves and focus departs. Default `150`.                    |
| `description`  | `string`                                                                                                                                                                                   | no       | —                | Visually hidden text wired to the trigger via aria-describedby for assistive technology context.                           |
| `offset`       | `number`                                                                                                                                                                                   | no       | `8`              | Distance in pixels between the trigger and the card. Default `8`.                                                          |
| `open`         | `boolean`                                                                                                                                                                                  | no       | —                | Controls the open state of the card; bindable for controlled usage.                                                        |
| `openDelay`    | `number`                                                                                                                                                                                   | no       | `300`            | Delay in milliseconds before the card opens after the pointer enters or focus lands on the trigger. Default `300`.         |
| `placement`    | `"top"` \| `"top-start"` \| `"top-end"` \| `"right"` \| `"right-start"` \| `"right-end"` \| `"bottom"` \| `"bottom-start"` \| `"bottom-end"` \| `"left"` \| `"left-start"` \| `"left-end"` | no       | `"bottom-start"` | Preferred placement of the card relative to the trigger. Default `bottom-start`.                                           |
