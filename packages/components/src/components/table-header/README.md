...
| ---------------- | ---------- | -------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `allSelected`    | `boolean`  | no       | —       | Checked state for the select-all checkbox.                                                                                                                                                                 |
...
| `someSelected`   | `boolean`  | no       | —       | When true and `allSelected` is false, the select-all checkbox renders as indeterminate. The browser exposes that as `aria-checked="mixed"` to assistive tech.                                              |
...
| `onSelectAll`    | `(opaque)` | no       | —       | Called when the user activates the select-all checkbox. Not expressible in JSON Schema; see the component types for the signature.                                                                         |
