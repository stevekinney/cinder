...
const schema = {
  ...
  properties: {
    ...
    capture: {
      enum: [false, true, 'user', 'environment', null],
    },
    checked: {
    ...
    formenctype: {
      enum: ['application/x-www-form-urlencoded', 'multipart/form-data', 'text/plain', null],
    },
    formmethod: {
      enum: ['dialog', 'get', 'post', 'DIALOG', 'GET', 'POST', null],
    },
    formnovalidate: {
      enum: [false, true, null],
    },
    ...
    enterkeyhint: {
      enum: ['search', 'enter', 'done', 'go', 'next', 'previous', 'send', null],
    },
    hidden: {
    ...
    inputmode: {
      enum: ['email', 'search', 'tel', 'text', 'url', 'none', 'numeric', 'decimal', null],
      description:
    ...
    'aria-current': {
      enum: [false, true, 'date', 'time', 'true', 'false', 'page', 'step', 'location', null],
      description:
    ...
    'aria-haspopup': {
      enum: [false, true, 'dialog', 'true', 'false', 'grid', 'listbox', 'menu', 'tree', null],
      description:
