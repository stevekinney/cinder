...
| `value`      | `string` \| `number` \| `false` \| `true` \| (`string` \| `number` \| `false` \| `true` \| `object` \| (`string` \| `number` \| `false` \| `true` \| `object` \| (`string` \| `number` \| `false` \| `true` \| `object` \| (`string` \| `number` \| `false` \| `true` \| `object` \| `null`)[] \| `null`)[] \| `null`)[] \| `null`)[] \| `object` \| `null` | no       | —       | The payload value to inspect. Pass any JSON-serializable value — object, array, string, number, boolean, or null. Pass a string for already- serialized JSON; the component will attempt to parse it. Pass `undefined` when no payload is available yet.                                                                                                                                                                                                                                |
