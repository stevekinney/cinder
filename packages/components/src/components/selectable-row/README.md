...
| `currentValue`    | `"page"` \| `"step"` \| `"location"` \| `"date"` \| `"time"` \| `"true"` | no       | `"page"`        | `aria-current` value emitted for a selected link or a selected button using `selectedState="current"`.                                                                |
