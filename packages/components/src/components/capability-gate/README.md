...
| `children`         | `(opaque)`                                                                                                           | no       | —          | Custom content rendered below the status text and before the actions. A function or snippet prop. Its shape is not captured by the JSON schema; see the component types for the exact signature. |
| `onDismiss`        | `(opaque)`                                                                                                           | no       | —          | Called when the gate is dismissed. A function or snippet prop. Its shape is not captured by the JSON schema; see the component types for the exact signature.                                    |
| `onFallbackAction` | `(opaque)`                                                                                                           | no       | —          | Called when the fallback action button is activated. A function or snippet prop. Its shape is not captured by the JSON schema; see the component types for the exact signature.                  |
| `onPrimaryAction`  | `(opaque)`                                                                                                           | no       | —          | Called when the primary action button is activated. A function or snippet prop. Its shape is not captured by the JSON schema; see the component types for the exact signature.                   |
