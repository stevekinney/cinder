...
| `selectionRequired` | `boolean`                                       | no       | `true`  | When true, clicking the already-selected option is a no-op. When false, clicking the selected option clears value to undefined.                                                                                                                                                                                                                                                                                                                                                |
