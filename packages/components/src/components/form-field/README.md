...
| `managed`      | `(opaque)` | no       | —       | Policy ownership metadata displayed without disabling the control. Not expressible in JSON Schema; see the component types for the signature. |
