...
| `selectable`             | `"none"` \| `"single"` \| `"multiple"`           | no       | —       | Enables row selection. `"none"` renders no selection controls, `"single"` allows one selected row id, and `"multiple"` allows any number. Defaults to `"none"`.                                                                                                                                                                                                                                                                                            |
