...
| `steps`          | `(opaque)`                     | yes      | —       | Ordered list of step entries from first to last. A prop whose shape is not captured by the JSON schema; see the component types for the exact signature.         |
