...
| ----------------- | ------------------ | -------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `class`           | `string`           | no       | —       | Custom class merged with `.cinder-input-field` on the root wrapper.                                                                                                                                                                                                                                                                                                                                         |
...
| `adornment`       | `(opaque)`         | no       | —       | Optional non-interactive adornment rendered before the stepper controls. Not expressible in JSON Schema; see the component types for the signature.                                                                                                                                                                                                                                                         |
