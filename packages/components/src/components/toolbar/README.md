...
| `children`    | `(opaque)`                     | yes      | —              | Controls rendered inside the toolbar. A function or snippet prop. Its shape is not captured by the JSON schema; see the component types for the exact signature. |
