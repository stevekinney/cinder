...
| `cancelLabel`      | `string`   | no       | —       | Label for the cancel button. When omitted, NO cancel button is rendered — an alert dialog's default shape is a single acknowledgement.                                                |
