...
| `onValueChange` | `(opaque)`                                                | no       | —             | Called with the next right-side value after a transfer. Not expressible in JSON Schema; see the component types for the signature.              |
