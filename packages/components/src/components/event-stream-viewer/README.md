...
| `events`          | ({ datetime?: `string`; details?: `string` \| `number` \| `false` \| `true` \| (`string` \| `number` \| `false` \| `true` \| `object` \| `null`)[] \| `object` \| `null`; id: `string`; kind?: `"reconnected"`; replayedCount?: `number`; sequence?: `number`; severity?: `"debug"` \| `"info"` \| `"success"` \| `"warning"` \| `"error"`; source?: `string`; summary?: `string`; timestamp?: `string` })[] | yes      | —       | Events and additive boundary entries to render in chronological order, oldest first.                                                                                                                                                                                     |
