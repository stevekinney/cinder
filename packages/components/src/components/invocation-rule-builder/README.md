...
| `actionOptions`     | `(opaque)` | yes      | —       | Options for the action target selector. Consumer-provided list of targets, e.g. review-agent slugs or step identifiers. Not expressible in JSON Schema; see the component types for the signature.                                                  |
| `fieldOptions`      | `(opaque)` | yes      | —       | Options for the condition field selector. Consumer-provided list of fields that a condition can test, e.g. "path", "label", "author". Not expressible in JSON Schema; see the component types for the signature.                                    |
...
| `operatorOptions`   | `(opaque)` | yes      | —       | Options for the condition operator selector. Consumer-provided list of operators, e.g. "matches", "is", "is-not", "contains". Not expressible in JSON Schema; see the component types for the signature.                                            |
| `rules`             | `(opaque)` | yes      | —       | The current list of automation rules. Controlled — pass the updated list returned from `onchange` back into this prop to commit a change. Not expressible in JSON Schema; see the component types for the signature.                                |
