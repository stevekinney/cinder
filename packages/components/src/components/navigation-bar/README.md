...
| `label`               | `string`                              | no       | `"Main navigation"` | Accessible name for the <nav> landmark. Wins over any aria-label passed via rest. Default 'Main navigation'.                                                                                                                                                                                        |
| `labelsVisible`       | `"always"` \| `"active"` \| `"never"` | no       | `"always"`          | Label visibility for mobile bottom-tab compositions. Hidden labels remain in the accessibility tree when wrapped in `[data-cinder-navigation-label]`.                                                                                                                                               |
| `menuTogglePlacement` | `"after-brand"` \| `"before-brand"`   | no       | `"after-brand"`     | Placement for the collapsible mobile menu toggle in top navigation bars. Ignored for `placement="bottom"`.                                                                                                                                                                                          |
