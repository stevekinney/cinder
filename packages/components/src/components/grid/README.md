...
| `columns`      | `string` \| `number` | no       | —       | Positive integer number of equal-width columns or a full CSS `grid-template-columns` value. Numeric values render as `repeat(<columns>, 1fr)`. |
