...
| `onSortModelChange` | `(opaque)`                                     | no       | —       | Called after DataGrid writes a user-initiated sort model change. Not expressible in JSON Schema; see the component types for the signature.   |
...
| `sortModel`         | `(opaque)`                                     | no       | —       | Bound sort model. DataGrid reorders rendered rows from this model. Not expressible in JSON Schema; see the component types for the signature. |
