...
| `density`         | `"compact"` \| `"comfortable"` \| `"spacious"` | no       | —       | Controls body row padding density.                                                                                                        |
| `stickyHeader`    | `boolean`                                      | no       | —       | Keeps the column header row pinned to the top edge while scrolling.                                                                       |
