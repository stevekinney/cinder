...
| `operation`          | { argsPreview?: `unknown`; command?: `string`; diff?: `string`; filesTouched?: `string`[]; kind: `"command"` \| `"file-write"` \| `"patch"` \| `"other"` } | yes      | —       | Operation details shown to the approver.                                                                                                                 |
