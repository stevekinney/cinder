...
| `operation`          | { argsPreview?: `string` \| `number` \| `false` \| `true` \| (`string` \| `number` \| `false` \| `true` \| `object` \| `null`)[] \| `object` \| `null`; command?: `string`; diff?: `string`; filesTouched?: `string`[]; kind: `"command"` \| `"file-write"` \| `"patch"` \| `"other"` } | yes      | —       | Operation details shown to the approver.                                                                                                                 |
