# StatisticsSection · accessibility

## Pattern

StatisticsSection wraps StatisticGroup/Statistic to present key numeric outcomes.

## Keyboard and focus

- StatisticsSection is informational and non-interactive by default.
...
Related components: `statistic-group`, `statistic`, `pricing-section`.
