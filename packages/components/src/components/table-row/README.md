...
| `children`          | `(opaque)` | yes      | —       | Cell children (TableCell or TableHeaderCell). A function or snippet prop. Its shape is not captured by the JSON schema; see the component types for the exact signature.                                                                                                           |
