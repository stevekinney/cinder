...
| `tone`           | `"neutral"` \| `"info"` \| `"success"` \| `"warning"` \| `"error"` | no       | —       | Semantic tone for the rail marker (icon badge or dot). Default `neutral`. Colour is never the only signal — pair a non-neutral tone with a distinct icon shape or state wording in the entry body.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
