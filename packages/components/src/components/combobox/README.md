...
| `allowCustomValue`  | `(opaque)` | no       | —       | Allow committing typed text that is not present in `options`. Not expressible in JSON Schema; see the component types for the signature.                                                                                               |
