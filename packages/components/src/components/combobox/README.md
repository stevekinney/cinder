...
| `onchange`           | `(opaque)` | no       | —       | Called when an option, or an arbitrary value when enabled, is committed. Not expressible in JSON Schema; see the component types for the signature.                                                                                    |
