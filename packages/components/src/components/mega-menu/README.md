...
| `indicatorVisible` | `boolean`                      | no       | `true`              | Render an active trigger indicator bar.                                                                       |
| `label`            | `string`                       | no       | `"Main navigation"` | Accessible name for the navigation landmark.                                                                  |
| `openOnHover`      | `boolean`                      | no       | `false`             | Hover opens top-level content instead of click-only mode.                                                     |
| `viewportVisible`  | `boolean`                      | no       | `true`              | Render the shared content viewport wrapper.                                                                   |
