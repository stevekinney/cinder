...
| `dismissible` | `boolean`                                            | no       | `true`   | Whether the banner shows a dismiss (×) button. Default `true`.                                                                                                                                  |
| `variant`     | `"info"` \| `"success"` \| `"warning"` \| `"danger"` | no       | `"info"` | Visual + semantic variant. Default `'info'`.                                                                                                                                                    |
