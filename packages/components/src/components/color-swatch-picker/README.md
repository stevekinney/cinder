...
| `value`         | `string`                                       | no       | —       | Bindable selected color.                                                                                                                                                                                                           |
...
| `onValueChange` | `(opaque)`                                     | no       | —       | Fired when the selected swatch changes. Not expressible in JSON Schema; see the component types for the signature.                                                                                                                 |
