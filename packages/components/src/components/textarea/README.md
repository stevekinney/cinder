...
| `class`       | `(opaque)` | no       | —       | Extra class names merged with `.cinder-textarea`. A prop whose shape is not captured by the JSON schema; see the component types for the exact signature.                                                                                                                                                                                              |
| `value`       | `(opaque)` | no       | —       | Bound value of the textarea. A prop whose shape is not captured by the JSON schema; see the component types for the exact signature.                                                                                                                                                                                                                   |
