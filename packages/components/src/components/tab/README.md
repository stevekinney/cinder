...
| `controls` | `string`   | no       | —       | Optional explicit `aria-controls` target for caller-owned panels. By default, Cinder points at the matching TabPanel id (`${baseId}-panel-${value}`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
