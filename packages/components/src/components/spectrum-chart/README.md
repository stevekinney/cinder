...
| `label`               | `string`                                            | yes      | —       |                                                                                                                                                                     |
| `loading`             | `boolean`                                           | no       | —       |                                                                                                                                                                     |
| `empty`               | `(opaque)`                                          | no       | —       | Snippet rendered when there are no bins. A function or snippet prop. Its shape is not captured by the JSON schema; see the component types for the exact signature. |
