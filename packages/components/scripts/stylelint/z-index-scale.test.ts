...
describe('cinder/z-index-scale', () => {
  ...
  test.each([
    ...
    ['calc(hypot(var(--runtime), 9999fr) / 1fr)', 1],
    ['calc(hypot(9999fr, var(--runtime)) / 1px * var(--conversion, 1))', 1],
    ['first-valid(calc(hypot(9999fr, var(--runtime)) / 1px * var(--conversion, 1)), 1)', 1],
    ...
    ['first-valid(calc(hypot(9999fr, var(--runtime)) / 1px), 1)', 0],
    ['if(style(--flag: yes): calc(hypot(9999fr, var(--runtime)) / 1px); else: 1)', 0],
    ['calc(hypot(9999fr, var(--runtime), 1px) / 1fr)', 0],
    ['calc(0 * hypot(9999fr, var(--runtime)) / 1fr)', 0],
    ['clamp(0, calc(hypot(9999fr, var(--runtime)) / 1fr), 1)', 0],
    ['hypot(9999fr, var(--runtime))', 0],
