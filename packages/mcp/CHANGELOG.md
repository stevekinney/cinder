...
- Updated dependencies [[`167247f`](https://github.com/stevekinney/cinder/commit/167247f6111653a94b99089ceb9b99a67f3c96d1)]:
  - @lostgradient/cinder@0.26.2
...
- Updated dependencies [[`a5da0de`](https://github.com/stevekinney/cinder/commit/a5da0deff25d30d206d7176ee9021403942acfcf)]:
  - @lostgradient/cinder@0.25.1

## 0.1.14

### Patch Changes

- [#1419](https://github.com/stevekinney/cinder/pull/1419) [`c760383`](https://github.com/stevekinney/cinder/commit/c760383ff4933b21175477b1ba1306b16adccd67) Thanks [@stevekinney](https://github.com/stevekinney)! - Pick up the `components.json` catalog change from the `BentoGrid`/`BentoCell` → `Grid`/`Grid.Item` fold: `loadCinderKnowledge()` no longer surfaces `bento-grid`/`bento-cell`, and `grid-item` now documents `rowEnd`. No tool API change.
