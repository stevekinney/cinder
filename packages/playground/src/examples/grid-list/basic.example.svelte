<script lang="ts" module>
  export const title = 'Basic grid list';
...
<script lang="ts">
  ...
  const projects = [
    ...
    { name: 'Atlas', summary: 'Documentation site generator.' },
    { name: 'Beacon', summary: 'Observability dashboards.' },
    { name: 'Cinder', summary: 'Svelte component library.' },
  ];
</script>
