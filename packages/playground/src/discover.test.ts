...
describe('discoverSidebarComponents', () => {
  ...
  it('keeps the sidebar at or below the 128-entry product gate', async () => {
    ...
    // bringing the measured ceiling to 127. SchemaForm adds one public form
    // family with JSON Schema and Standard Schema examples, bringing the
    // measured ceiling to 128.
    const sidebar = await discoverSidebarComponents();
