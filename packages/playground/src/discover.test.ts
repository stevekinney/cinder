...
describe('discoverSidebarComponents', () => {
  ...
  it('keeps the sidebar at or below the 127-entry product gate', async () => {
    ...
    // its first playground example. In parallel, SchemaForm adds one public form
    // family with JSON Schema and Standard Schema examples. Together, they bring
    // the measured sidebar ceiling to 127.
    const sidebar = await discoverSidebarComponents();
